...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Making machines learn,adapt, and evolve
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Passionate AI & Machine Learning Student at Vel Tech, specializing in Deep Learning, NLP, Generative AI, and Data Science. Skilled in Python and AI-driven product development, I focus on solving real-world problems through research and innovation in Data Science, Analytics, and cutting-edge AI technologies.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "I Help Businesses Grow with AI."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1LLCN8ChhmiwL80Rw3uUxjWd4qfctGSX5/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
