...
const WORDS = ["AI & Data Science Student", "AI Intern"];
const TECH_STACK = ["Python", "Tensorflow", "Scikit-learn", "Pandas"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Ishtiyaq-Marzuq" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ishtiyaq-marzuq/" },
  { icon: Instagram, link: "https://www.instagram.com/ishtiyaq__marzuq/" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/7fc6c633-b52f-4aeb-a301-bb8f99fc7363/ycjdz0kndA.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Developing Accurate, Adaptive, and Impactful Machine Learning Models for Tomorrow’s Technology.
                </p>
